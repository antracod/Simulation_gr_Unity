...
public class EquipmentManager : MonoBehaviour {
	...
	public void Equip (Equipment newItem)
	{
		...
		Transform target1 = GameObject.FindWithTag("XWEAPON").transform;
		Transform target2 = GameObject.FindWithTag("XSHIELD").transform;
		rightHandTransform = target1;
		leftHandTransform = target2;
